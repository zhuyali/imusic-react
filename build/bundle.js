...
/******/ 	var hotCurrentHash = "01b0184d7a8ae5844149"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MusicPanel = __webpack_require__(6);

	ReactDOM.render(React.createElement(MusicPanel, null), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tape = __webpack_require__(7);
	var ControlPanel = __webpack_require__(15);
	var MusicList = __webpack_require__(20);
	...
	var MusicPanel = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(Tape, { paused: this.state.paused }),
	      React.createElement(ControlPanel, { musicLength: this.state.musicLength, index: this.state.index, paused: this.state.paused, changeState: this.onStateChanged, changeMusic: this.onMusicChanged, stopped: this.state.stopped }),
	      React.createElement(MusicList, { source: '/api/get_musics', getMusics: this.onMusicsGet, changeMusic: this.onMusicChanged }),
	      React.createElement(
	        'audio',
	...
	var ControlPanel = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'audio',
	        { id: 'soundAudio', ref: 'audio', src: './click.mp3' },
	        _react2.default.createElement(
	          'span',
	          null,
	          'HTML5 audio not supported'
